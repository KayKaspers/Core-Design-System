...
_SPECS: dict[str, DiagnosticSpec] = {
    ...
    for spec in (
        ...
        DiagnosticSpec("CDS-V4-NOT-ASSESSED", "V4", Severity.INFO, "not-assessed",
                       ("DEC-S-097",), ()),
        # V4 — semantic status vocabulary (CDS-WP-015; existing codes unchanged)
        DiagnosticSpec("CDS-V4-STATUS-AXIS", "V4", Severity.ERROR, "semantic-status-axis",
                       ("DEC-S-105", "DEC-S-118"), ("RISK-090",)),
        DiagnosticSpec("CDS-V4-STATUS-VALUE", "V4", Severity.ERROR, "semantic-status-value",
                       ("DEC-S-106", "DEC-S-118"), ("RISK-090",)),
        DiagnosticSpec("CDS-V4-STATUS-UNKNOWN", "V4", Severity.ERROR, "semantic-status-unknown",
                       ("DEC-S-106", "DEC-S-107", "DEC-S-118"), ("RISK-083", "RISK-090")),
        DiagnosticSpec("CDS-V4-STATUS-COUNT", "V4", Severity.ERROR, "semantic-status-count",
                       ("DEC-S-116", "DEC-S-118"), ("RISK-090",)),
        DiagnosticSpec("CDS-V4-STATUS-PATH-VALUE", "V4", Severity.ERROR,
                       "semantic-status-path-value",
                       ("DEC-S-117", "DEC-S-118"), ("RISK-090", "RISK-092")),
        DiagnosticSpec("CDS-V4-STATUS-COLLISION", "V4", Severity.ERROR,
                       "semantic-status-collision",
                       ("DEC-S-117", "DEC-S-118"), ("RISK-092",)),
        DiagnosticSpec("CDS-V4-STATUS-AGGREGATE", "V4", Severity.ERROR,
                       "semantic-status-aggregate",
                       ("DEC-S-108", "DEC-S-118"), ("RISK-084", "RISK-090")),
        DiagnosticSpec("CDS-V4-STATUS-VISUAL-LEAKAGE", "V4", Severity.ERROR,
                       "semantic-status-visual-leakage",
                       ("DEC-S-111", "DEC-S-118"), ("RISK-087", "RISK-091")),
