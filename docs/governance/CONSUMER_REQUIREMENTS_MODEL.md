...
| CR-024 | Deferred Requirement | Inferred – Human validation required | Inferred requirement requiring Human Maintainer validation | Should | CDS-owned candidate | Resolved at policy level by CDS-WP-007 (WCAG 2.2 AA, DEC-S-060), committed and in effect; evidence absent, no conformance claim | CDS-WP-008 | Open |
