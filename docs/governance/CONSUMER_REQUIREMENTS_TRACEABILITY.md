...
| CR-024 | CO, SP | 399de21c · a5e69771 | CO `…/COREOPS_CONCEPT_V3.md` baseline; SP `docs/branding/ui-principles.md` | Governance | Deferred Requirement | — | **Resolved at policy level by CDS-WP-007 — WCAG 2.2 AA target (DEC-S-060); activates on Human Maintainer commit; evidence still absent, no conformance claim** | CDS-WP-008 | Open |
