...
| CR-021 | SP | a5e69771 | SP `docs/branding/ui-principles.md` P6 | Foundations | Shared CDS Candidate | E | Pilot Group E keyboard and focus check | CDS-WP-007 | Open |
| CR-022 | SP | a5e69771 | SP `docs/branding/ui-principles.md` P1/P6 | Foundations | Shared CDS Candidate | E | Pilot Group E reduced-motion check | CDS-WP-007 | Open |
...
| CR-024 | CO, SP | 399de21c · a5e69771 | CO `…/COREOPS_CONCEPT_V3.md` baseline; SP `docs/branding/ui-principles.md` | Governance | Deferred Requirement | — | Human Maintainer decision; no conformance claim meanwhile | CDS-WP-007 | Deferred |
