...
`a6bd7bf0c290886bbe2695c0f9cf70efbef3f1e9`, and **not closed**. **`WP021-D1` is
APPROVED** and recorded
as **`DEC-S-136`** with **`ADR-0006`** (**both effective at that commit**);
**`WP021-D2` is
